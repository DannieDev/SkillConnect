    ...
    <div className="px-4 sm:px-6 py-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white shadow-md p-6 rounded-md">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-3">
          <h2 className="text-2xl font-bold text-gray-900">{servicio.titulo}</h2>
          <button
        ...
        <div className="mb-10">
          <Link href={`/cliente/pago/${id}`}>
            <button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg shadow">
        ...
        {/* Comentarios */}
        <div>
          <h3 className="text-xl font-semibold mb-4 text-gray-800">Comentarios</h3>
          ...
          <div className="space-y-4">
            {comentarios.map((c, i) => (
              <div
                key={i}
                className="bg-gray-50 p-4 rounded-md flex flex-col sm:flex-row gap-3 items-start"
              >
                <img
